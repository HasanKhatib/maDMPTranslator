...
namespace maDMPTranslator.Logic
{
    public class DMPHorizonLogic : IDMPLogic
    {
        ...
        public Dictionary<string, string> InitializeAnswersDict()
        {
            ...
            AnswersDict["FAIR_2_1"] = "Answer_Making data findable, including provisions for metadata";
            ...
            AnswersDict["FAIR_2_2"] = "Answer_Making data openly accessible";
            ...
            AnswersDict["FAIR_2_3"] = "Answer_Making data interoperable";
            ...
            AnswersDict["FAIR_2_4"] = "Answer_Increase data re-use (through clarifying licences)";
            ...
            AnswersDict["ALLOCATION_3"] = "Answer_Allocation of resources";
            ...
            AnswersDict["SECURITY_4"] = "Answer_Data Security";
            ...
            AnswersDict["ETHICAL_5"] = "Answer_Ethical aspects";
            ...
            AnswersDict["OTHER_6"] = "Answer_Other issues";
